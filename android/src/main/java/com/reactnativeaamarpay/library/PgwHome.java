package com.reactnativeaamarpay.library;
...
import com.reactnativeaamarpay.R;

import static com.reactnativeaamarpay.library.AamarPay.listener;

public class PgwHome extends AppCompatActivity implements AdvancedWebView.Listener {

    private View pgw_loading;
    private String store_id, signature_key, trxID, success_url_suffix, fail_url_suffix, cancel_url_suffux;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        success_url_suffix = getIntent().getStringExtra("SUCCESS_URL_SUFFIX");
        fail_url_suffix = getIntent().getStringExtra("FAIL_URL_SUFFIX");
        cancel_url_suffux = getIntent().getStringExtra("CANCEL_URL_SUFFIX");
    ...
    public void onPageStarted(String url, Bitmap favicon) {
        ...
        if (url.contains(success_url_suffix)) {
            paymentSuccess = true;
