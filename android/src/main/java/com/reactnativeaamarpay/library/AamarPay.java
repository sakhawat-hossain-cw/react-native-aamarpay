...
import com.reactnativeaamarpay.library.Retrofit.LiveClient;
import com.reactnativeaamarpay.library.Retrofit.SandboxClient;
...
public class AamarPay {
                        ...
                        if (response.body() != null) {
                            ...
                            if (resp.contains("Invalid Store ID")) {
                                ...
                                try {
                                    ...
                                    createPGWHActivity(payment_url);
    ...
    private void createPGWHActivity(String payment_url){
        try{
            Intent intent = new Intent(this.context, PgwHome.class);
            intent.putExtra("URL", payment_url);
            intent.putExtra("TEST_MODE", this.isTestMode);
